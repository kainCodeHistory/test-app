        ...
        {{ csrf_field() }}
              ...
              <div class="col-sm-6">
                  <div class="input-group">
					...
					<input type="text" class="form-control" id="email" name="email" placeholder="請輸入電子郵件" value="{{ old('email') }}">
            ...
            <div class="form-group {{ $errors->has('group')?"has-error":"" }}">
                ...
                <div class="col-sm-6">
                  <input type="hidden" class="form-control" id="group" name="group" value="1" >
                  <div class="input-group">
                    <span class="input-group-addon">&nbsp;&nbsp;&nbsp;群&nbsp;&nbsp;&nbsp;&nbsp;組&nbsp;&nbsp;&nbsp;</span>
                    <input type="text" class="form-control" id="group_text" aria-describedby="groupHelp" value="無群組" readonly onclick="selectGroup()" >
                  </div>
